...
Further details, and a user guide, can be found in the \user_guide subfolder of the plugin installation directory (see file "[3DCityDBTools_UserGuide.pdf](user_guide/3DCityDBToos_UserGuide_0.7.pdf)").
