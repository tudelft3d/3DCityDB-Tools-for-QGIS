...
ALTER TABLE qgis_pkg.extents ADD CONSTRAINT extents_schema_bbox_unique UNIQUE (cdb_schema, bbox_type);

INSERT INTO qgis_pkg.extents (cdb_schema, bbox_type, label) VALUES
