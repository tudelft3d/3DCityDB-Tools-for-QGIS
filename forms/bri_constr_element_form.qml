...
<qgis styleCategories="Symbology|Symbology3D|Fields|Forms" version="3.22.3-Białowieża">
  <renderer-3d type="vector" layer="rail_bri_constr_elem_lod3_9ac4a43a_42b0_41ef_ac29_b56402eff74f">
    ...
    <symbol type="polygon" material_type="phong">
      ...
      <material specular="255,255,255,255" diffuse="153,149,137,255" ambient="25,25,25,255" shininess="0">
      ...
      <symbol name="0" alpha="1" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="153,149,137,255"/>
          ...
          <prop k="color" v="153,149,137,255"/>
  ...
  <fieldConfiguration>
    ...
    <field name="bridge_id" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option name="IsMultiline" type="bool" value="false"/>
  ...
  <aliases>
    ...
    <alias name="Bridge ID" field="bridge_id" index="20"/>
  </aliases>
  <defaults>
    ...
    <default field="bridge_id" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint constraints="0" notnull_strength="0" unique_strength="0" field="bridge_id" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="bridge_id" exp=""/>
  </constraintExpressions>
  <expressionfields/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Bridge Installation Attributes" visibilityExpression="" columnCount="2" showLabel="1" groupBox="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="bridge_id" showLabel="1" index="20"/>
    </attributeEditorContainer>
  ...
  <editable>
    <field name="bridge_id" editable="1"/>
  ...
  <labelOnTop>
    <field name="bridge_id" labelOnTop="0"/>
  ...
  <reuseLastValue>
    <field name="bridge_id" reuseLastValue="0"/>
