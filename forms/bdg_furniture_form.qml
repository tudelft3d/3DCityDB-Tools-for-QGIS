...
<qgis styleCategories="Symbology|Symbology3D|Fields|Forms" version="3.22.3-Białowieża">
  <renderer-3d type="vector" layer="citydb_bdg_furniture_lod4_8e4b75e4_9e69_45dd_883e_27fe17cba8da">
    ...
    <symbol type="polygon" material_type="phong">
      ...
      <material specular="255,255,255,255" diffuse="114,155,111,255" ambient="25,25,25,255" shininess="0">
  ...
  <aliases>
    ...
    <alias name="Room ID" field="room_id" index="20"/>
    <alias name="Building ID" field="building_id" index="21"/>
  </aliases>
  <defaults>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Building Furniture Attributes" visibilityExpression="" columnCount="1" showLabel="1" groupBox="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="building_id" showLabel="1" index="21"/>
      <attributeEditorField name="room_id" showLabel="1" index="20"/>
    </attributeEditorContainer>
