...
<qgis styleCategories="Symbology|Symbology3D|Fields|Forms" version="3.22.3-Białowieża">
  <renderer-3d type="vector" layer="rail_tun_out_inst_lod3_f6a9033e_259b_45a7_b1ca_96fb4e5ef077">
    ...
    <symbol type="polygon" material_type="phong">
      ...
      <material specular="255,255,255,255" diffuse="255,235,175,255" ambient="25,25,25,255" shininess="0">
      ...
      <symbol name="0" alpha="1" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          <Option type="Map">
            ...
            <Option name="color" type="QString" value="255,235,175,255"/>
  ...
  <aliases>
    ...
    <alias name="Tunnel ID" field="tunnel_id" index="20"/>
  </aliases>
  <defaults>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorContainer name="Tunnel Installation Attributes" visibilityExpression="" columnCount="2" showLabel="1" groupBox="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="tunnel_id" showLabel="1" index="20"/>
    </attributeEditorContainer>
