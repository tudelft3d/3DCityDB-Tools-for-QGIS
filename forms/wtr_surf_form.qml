...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="0,58,213,127">
      </material>
...
<!-- Set the colour of the 2D geometries -->
            <Option type="QString" name="color" value="0,58,213,127"/>
...
<!-- cfu attributes -->
<!-- other attributes -->
    <field configurationFlags="None" name="water_level">
      <editWidget type="TextEdit">
	  </editWidget>
    </field>
    <field configurationFlags="None" name="water_level_codespace">
      <editWidget type="TextEdit">
	  </editWidget>
    </field>
...
<!-- other attributes attributes -->
    <alias index="20" name="Water level" field="water_level"/>
    <alias index="21" name="Codespace" field="water_level_codespace"/>
...
<!-- other attributes -->
    <attributeEditorContainer visibilityExpression="" groupBox="1" name="Feature-specific attributes" columnCount="2" showLabel="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="water_level" showLabel="1" index="20"/>
      <attributeEditorField name="water_level_codespace" showLabel="1" index="21"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
...
<!-- cfu attributes -->
<!-- other attributes -->
    <field editable="0" name="water_level_codespace"/>
