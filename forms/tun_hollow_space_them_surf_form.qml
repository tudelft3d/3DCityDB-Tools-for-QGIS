...
<!-- root/parent attributes -->
    <field configurationFlags="None" name="tunnel_hollow_space_id">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- parent/root attributes -->
    <alias index="101" name="Tunnel hollow space ID" field="tunnel_hollow_space_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="tunnel_hollow_space_id" showLabel="1" index="101"/>
...
<!-- parent and root attributes -->
    <field editable="0" name="tunnel_hollow_space_id"/>
  </editable>
