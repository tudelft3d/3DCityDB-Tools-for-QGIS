...
<qgis styleCategories="Symbology|Symbology3D|Fields|Forms" version="3.22.3-Białowieża">
  <renderer-3d type="vector" layer="citydb_bdg_lod1_efdd67ad_0d37_4f9a_bd6c_8ebf33758fd3">
    ...
    <symbol type="polygon" material_type="phong">
      ...
      <material specular="255,255,255,255" diffuse="228,26,28,255" ambient="25,25,25,255" shininess="0">
  ...
  <aliases>
    ...
    <alias name="Roof Type codespace" field="roof_type_codespace" index="23"/>
    <alias name="Height" field="measured_height" index="24"/>
    <alias name="Height UoM" field="measured_height_unit" index="25"/>
    ...
    <alias name="Storey height above ground UoM" field="storey_heights_ag_unit" index="29"/>
