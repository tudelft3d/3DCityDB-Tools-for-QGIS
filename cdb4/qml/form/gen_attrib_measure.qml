...
<qgis version="3.22.16-Białowieża" styleCategories="Fields|Forms">
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="uom">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="false" type="bool" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias name="UoM" field="uom" index="5"/>
    <alias name="Cityobject ID" field="cityobject_id" index="6"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="uom"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" notnull_strength="1" exp_strength="0" unique_strength="0" field="uom"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    ...
    <attributeEditorField showLabel="1" name="uom" index="5"/>
    <attributeEditorField showLabel="1" name="cityobject_id" index="6"/>
  </attributeEditorForm>
  <editable>
    <field editable="1" name="attrname"/>
    <field editable="0" name="cityobject_id"/>
    <field editable="0" name="id"/>
    <field editable="1" name="parent_genattrib_id"/>
    <field editable="1" name="root_genattrib_id"/>
    <field editable="1" name="uom"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="uom"/>
