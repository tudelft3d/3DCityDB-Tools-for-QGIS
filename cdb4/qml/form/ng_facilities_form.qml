...
<qgis styleCategories="Fields|Forms" version="3.22.4-Białowieża">
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="objectclass_id">
    ...
    <field configurationFlags="None" name="operationschedule_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="usagezone_equippedwith_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="objectclass_id" name="Object Class ID" index="16"/>
    <alias field="operationschedule_id" name="Operation Schedule ID" index="17"/>
    <alias field="usagezone_equippedwith_id" name="Usagezone Equipped With ID" index="18"/>
  </aliases>
  <defaults>
  </defaults>
  <constraints>
...
<!-- database info tab -->  
    ...
    <attributeEditorContainer name="HeatExchangeType" visibilityExpressionEnabled="0" showLabel="0" groupBox="0" visibilityExpression="" columnCount="1">
    </attributeEditorContainer>
    <attributeEditorContainer visibilityExpression="" groupBox="1" name="Feature-specific attributes" columnCount="2" showLabel="1" visibilityExpressionEnabled="0"> 	
      ...
      <attributeEditorField name="objectclass_id" showLabel="1" index="16"/>
      <attributeEditorField name="operationschedule_id" showLabel="1" index="17"/>
      <attributeEditorField name="usagezone_equippedwith_id" showLabel="1" index="18"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
    ...
    <field editable="0" name="objectclass_id"/>
    <field editable="0" name="operationschedule_id"/>
    <field editable="0" name="reason_for_update"/>
    <field editable="0" name="termination_date"/>
    <field editable="0" name="updating_person"/>
    <field editable="0" name="usagezone_equippedwith_id"/>
  </editable>
  <labelOnTop>
  </labelOnTop>
  <reuseLastValue>
