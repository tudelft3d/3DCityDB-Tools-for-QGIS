...
<!-- root/parent attributes -->
    <field configurationFlags="None" name="bridge_constr_element_id">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- parent/root attributes -->
    <alias index="101" name="Bridge Constr. Element ID" field="bridge_constr_element_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="bridge_constr_element_id" showLabel="1" index="101"/>
...
<!-- parent and root attributes -->
    <field editable="0" name="bridge_constr_element_id"/>
  </editable>
