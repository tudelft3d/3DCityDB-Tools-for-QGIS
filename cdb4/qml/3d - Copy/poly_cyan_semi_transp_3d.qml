...
<qgis styleCategories="Symbology3D" version="3.22.7-Białowieża">
...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="81,255,246,127">
      </material>
