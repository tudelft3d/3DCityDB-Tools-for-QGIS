...
--layer_id		varchar UNIQUE, -- contains the layer id to be used in th front-end
layer_name		varchar UNIQUE, -- contains the layer name
av_name			varchar, -- contains the attribute view name
gv_name			varchar,
n_features		integer,
creation_date	timestamptz(3),
...
COMMENT ON TABLE qgis_pkg.layer_metadata_template IS 'List of layers';
...
--CREATE INDEX lmeta_l_id_idx       ON qgis_pkg.layer_metadata_template (layer_id);
