...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="255,145,0,127">
      </material>
...
<!-- Set the colour of the 2D geometries -->
            <Option type="QString" name="color" value="255,145,0,127"/>
...
<!-- root/parent attributes -->
    <field name="building_installation_id" configurationFlags="None">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- parent/root attributes -->
    <alias index="101"  name="Building installation ID" field="building_installation_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="building_installation_id" showLabel="1" index="101"/>
...
<!-- parent and root attributes -->
    <field editable="0" name="building_installation_id"/>
  </editable>
