...
<!-- root/parent attributes -->
    <field configurationFlags="None" name="tunnel_installation_id">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- parent/root attributes -->
    <alias index="101" name="Tunnel installation ID" field="tunnel_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="tunnel_installation_id" showLabel="1" index="101"/>
...
<!-- parent and root attributes -->
    <field editable="0" name="tunnel_installation_id"/>
  </editable>
