...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="255,255,0,127">
      </material>
...
<!-- Set the colour of the 2D geometries -->
            <Option type="QString" name="color" value="255,255,0,127"/>
...
<!-- root/parent attributes -->
    <field configurationFlags="None" name="bridge_id">
      <editWidget type="TextEdit"></editWidget>
    </field>
    <field configurationFlags="None" name="bridge_room_id">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- parent/root attributes -->
    <alias index="101" name="Bridge(Part) ID" field="bridge_id"/>
    <alias index="102" name="Bridge room ID" field="bridge_room_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="bridge_room_id" showLabel="1" index="102"/>
      <attributeEditorField name="bridge_id" showLabel="1" index="101"/>
...
<!-- parent and root attributes -->
    <field editable="0" name="bridge_id"/>
    <field editable="0" name="bridge_room_id"/>
  </editable>
