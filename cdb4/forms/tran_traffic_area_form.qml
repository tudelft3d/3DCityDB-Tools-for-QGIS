...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="88,88,88,127">
      </material>
...
<!-- Set the colour of the 2D geometries -->
            <Option type="QString" name="color" value="88,88,88,127"/>
...
<!-- other attributes -->
    <field configurationFlags="None" name="surface_material">
      <editWidget type="TextEdit">
	  </editWidget>
    </field>
    <field configurationFlags="None" name="surface_material_codespace">
      <editWidget type="TextEdit">
	  </editWidget>
    </field>
<!-- root/parent attributes -->
    <field configurationFlags="None" name="transportation_complex_id">
      <editWidget type="TextEdit">
	  </editWidget>
    </field>
  </fieldConfiguration>
...
<!-- other attributes attributes -->
    <alias index="20" name="Surface material" field="surface_material"/>
    <alias index="21" name="Codespace" field="surface_material_codespace"/>
<!-- parent/root attributes -->
    <alias index="22" name="Transportation complex ID" field="transportation_complex_id"/>
  </aliases>
  <defaults></defaults>
  <constraints>
...
<!-- Parent/root attributes BEGIN -->
      <attributeEditorField name="transportation_complex_id" showLabel="1" index="22"/>
...
<!-- other attributes -->
    <attributeEditorContainer visibilityExpression="" groupBox="1" name="Feature-specific attributes" columnCount="2" showLabel="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="surface_material" showLabel="1" index="20"/>
      <attributeEditorField name="surface_material_codespace" showLabel="1" index="21"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
...
<!-- other attributes -->
    <field editable="0" name="surface_material_codespace"/>
<!-- parent and root attributes -->
    <field editable="0" name="transportation_complex_id"/>
  </editable>
