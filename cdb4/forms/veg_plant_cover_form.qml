...
<!-- Set the (diffuse) colour of the 3D geometries -->
       <material shininess="0" ambient="255,255,255,255" specular="255,255,255,255" diffuse="0,81,0,255">
      </material>
...
<!-- Set the colour of the 2D geometries -->
            <Option type="QString" name="color" value="0,81,0,255"/>
...
<!-- other attributes -->
    <field configurationFlags="None" name="average_height">
      <editWidget type="TextEdit"></editWidget>
    </field>
    <field configurationFlags="None" name="average_height_unit">
      <editWidget type="TextEdit"></editWidget>
    </field>
  </fieldConfiguration>
  <aliases>
...
<!-- other attributes -->
    <alias index="20" name="Average height" field="average_height"/>
    <alias index="21" name="UoM" field="average_height_unit"/>
  </aliases>
  <defaults></defaults>
  <constraints>
    <constraint constraints="3" exp_strength="0" notnull_strength="1" unique_strength="1" field="id"/>
<!-- other attributes -->	
    <constraint constraints="4" exp_strength="1" notnull_strength="0" unique_strength="0" field="average_height"/>
    <constraint constraints="4" exp_strength="1" notnull_strength="0" unique_strength="0" field="average_height_unit"/>
  </constraints>
  <constraintExpressions>
    <constraint field="height" desc="BOTH values must be either NULL or not NULL" exp="(&quot;average_height&quot; IS NOT NULL&#xd;&#xa;AND&#xd;&#xa;&quot;average_height_unit&quot; IS NOT NULL)&#xd;&#xa;OR&#xd;&#xa;(&quot;average_height&quot; IS NULL&#xd;&#xa;AND&#xd;&#xa;&quot;average_height_unit&quot; IS NULL)"/>
    <constraint field="height_unit" desc="BOTH values must be either NULL or not NULL" exp="(&quot;average_height&quot; IS NOT NULL&#xd;&#xa;AND&#xd;&#xa;&quot;average_height_unit&quot; IS NOT NULL)&#xd;&#xa;OR&#xd;&#xa;(&quot;average_height&quot; IS NULL&#xd;&#xa;AND&#xd;&#xa;&quot;average_height_unit&quot; IS NULL)"/>
  </constraintExpressions>
  <expressionfields/>
...
<!-- other attributes -->
    <attributeEditorContainer visibilityExpression="" groupBox="1" name="Feature-specific attributes" columnCount="2" showLabel="1" visibilityExpressionEnabled="0">
      <attributeEditorField name="average_height" showLabel="1" index="20"/>
      <attributeEditorField name="average_height_unit" showLabel="1" index="21"/>
    </attributeEditorContainer>
  </attributeEditorForm>
  <editable>
