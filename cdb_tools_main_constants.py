"""This module contains hardcoded variables that are used within the main plug-in class (CDBToolsMain)
"""
import os.path

# QGIS_VERSION_MINOR: tuple = (2,) # With one-item tuples, do not forget to add a column after it!! :-)
QGIS_VERSION_MINOR: tuple = (2, )
...
# User guite PDF file name
USER_GUIDE_FILE_NAME: str = "3DCityDB-Tools_UserGuide.pdf"
