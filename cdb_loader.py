...
######################################################
## This function is needed only by the user gui and should be rewritten in order to have a similar approach as in the admin gui.
######################################################

    def evt_update_bar(self, dialog, step, text) -> None:
        """Function to setup the progress bar upon update.
        Important: Progress Bar needs to be already created
