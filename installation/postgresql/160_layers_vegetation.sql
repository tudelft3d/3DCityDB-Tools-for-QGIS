...
--SELECT qgis_pkg.refresh_mviews_vegetation(usr_schema := 'qgis_user_ro', cdb_schema := 'citydb3'); 
--SELECT qgis_pkg.drop_layers_vegetation(usr_schema := 'qgis_user_ro', cdb_schema := 'citydb3');
